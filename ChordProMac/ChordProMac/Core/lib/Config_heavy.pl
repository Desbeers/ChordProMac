...
## Package name      : perl5
## Source directory  : .
## Configuration time: Fri Dec 29 03:43:55 UTC 2023
## Configured by     : root
## Target system     : darwin ventura-arm64.local 22.6.0 darwin kernel version 22.6.0: tue nov 7 21:40:04 pst 2023; root:xnu-8796.141.3.702.9~2release_arm64_vmapple arm64 
#
...
ccversion=''
cf_by='root'
cf_email='root@ventura-arm64.local'
cf_time='Fri Dec 29 03:43:55 UTC 2023'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
ld='cc'
ld_can_script='undef'
lddlflags=' -mmacosx-version-min=13.6 -bundle -undefined dynamic_lookup -fstack-protector-strong'
ldflags=' -mmacosx-version-min=13.6 -fstack-protector-strong'
...
mydomain='.local'
myhostname='ventura-arm64'
myuname='darwin ventura-arm64.local 22.6.0 darwin kernel version 22.6.0: tue nov 7 21:40:04 pst 2023; root:xnu-8796.141.3.702.9~2release_arm64_vmapple arm64 '
n=''
need_va_copy='undef'
...
perl_version='38'
perladmin='root@ventura-arm64.local'
perllibs=''
...
tee=''
test='test'
timeincl='/Library/Developer/CommandLineTools/SDKs/MacOSX13.3.sdk/usr/include/sys/time.h '
timetype='time_t'
tmpnam_r_proto='0'
to=':'
touch='touch'
...
ccflags_nolargefiles='-fno-common -DPERL_DARWIN -mmacosx-version-min=13.6 -DNO_POSIX_2008_LOCALE -fno-strict-aliasing -pipe -fstack-protector-strong'
ldflags_nolargefiles=' -mmacosx-version-min=13.6 -fstack-protector-strong'
