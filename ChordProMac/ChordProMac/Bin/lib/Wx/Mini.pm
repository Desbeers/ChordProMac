...
our $alien_key = 'mac_3_2_2_uni_nc_0';

{
    my $VAR1;
    $Wx::dlls = $VAR1 = {
          'html' => 'libwx_osx_cocoau_html-3.2.dylib',
          'ribbon' => 'libwx_osx_cocoau_ribbon-3.2.dylib',
          'webview' => 'libwx_osx_cocoau_webview-3.2.dylib',
          'gl' => 'libwx_osx_cocoau_gl-3.2.dylib',
          'aui' => 'libwx_osx_cocoau_aui-3.2.dylib',
          'net' => 'libwx_baseu_net-3.2.dylib',
          'richtext' => 'libwx_osx_cocoau_richtext-3.2.dylib',
          'xrc' => 'libwx_osx_cocoau_xrc-3.2.dylib',
          'qa' => 'libwx_osx_cocoau_qa-3.2.dylib',
          'propgrid' => 'libwx_osx_cocoau_propgrid-3.2.dylib',
          'media' => 'libwx_osx_cocoau_media-3.2.dylib',
          'base' => 'libwx_baseu-3.2.dylib',
          'stc' => 'libwx_osx_cocoau_stc-3.2.dylib',
          'core' => 'libwx_osx_cocoau_core-3.2.dylib',
          'xml' => 'libwx_baseu_xml-3.2.dylib'
        };
;
}
